...
const PHOTOS: Photo[] = [
  {
    ...
    subtitle: 'Team Dynamics — chassis design sprint at the workshop',
    date: 'Mar 2025',
    gradient: 'linear-gradient(135deg, #1a0533 0%, #4a1270 40%, #c0392b 100%)',
    tags: ['Engineering', 'Motorsport', 'CAD'],
  },
  {
    id: 'fs-2',
    title: 'Track Day',
    subtitle: 'Silverstone circuit testing — first run of the season',
    date: 'Apr 2025',
  ...
  },
  {
    ...
    subtitle: '24-hour build — won best UI/UX for distributed chat app',
    date: 'Nov 2024',
    gradient: 'linear-gradient(135deg, #0d1117 0%, #1f6feb 50%, #58a6ff 100%)',
    tags: ['Hackathon', 'React', 'Award'],
  },
  {
    id: 'deanos-demo',
    title: 'DeanOS Demo Day',
    subtitle: 'Presenting the browser OS to the department',
    date: 'Feb 2025',
    gradient: 'linear-gradient(135deg, #050a14 0%, #00D4FF22 50%, #00D4FF 100%)',
    tags: ['Portfolio', 'Presentation'],
  },
  {
    id: 'graduation',
    title: 'Freshers Week',
    subtitle: 'First week at university — met the CS cohort',
    date: 'Sep 2023',
  ...
  },
  {
    ...
    subtitle: 'Shipped carhire.deancimatu.com — full-stack solo build',
    date: 'Jan 2025',
